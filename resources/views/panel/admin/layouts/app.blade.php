        ...
        <nav class="navbar navbar-light bg-white navbar-expand-xl">
            ...
            <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    <a href="{{route('admin.cars.index')}}" class="nav-item nav-link {{ request()->routeIs('cars.index') ? 'active' : '' }}">Ana Sayfa</a>
                    <a href="{{route('admin.cars.create')}}" class="nav-item nav-link {{ request()->routeIs('cars.create') ? 'active' : '' }}">İlan Ver</a>
                    <a href="{{route('admin.brand.index')}}" class="nav-item nav-link {{ request()->routeIs('admin.brand.index') ? 'active' : '' }}">Markalar</a>

                    <a href="" class="nav-item nav-link">Kullanıcılar</a>
                </div>
